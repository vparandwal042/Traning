...
allPromise.then(success => console.log('Sum: ', success)).catch(error => console.log('Error: ', error));
//2
class classAccount {
...
var circle = {
    firstName: "radius",
    lastName: "diameter",
    print: () => { return circle.firstName + " " + circle.lastName; }
};
var employee = {
    firstName: "Vishal",
    lastName: "Parandwal",
    print: () => { return employee.firstName + " " + employee.lastName; }
};
